...
_simple:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
  18:	83 fa 01             	cmp    $0x1,%edx
  1b:	7e 3a                	jle    57 <main+0x57>
  1d:	8d 58 04             	lea    0x4(%eax),%ebx
  20:	8d 34 90             	lea    (%eax,%edx,4),%esi
  23:	90                   	nop
  ...
  35:	6a 01                	push   $0x1
  37:	e8 f4 03 00 00       	call   430 <printf>
  for(i = 1; i < argc; i++){
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	39 f3                	cmp    %esi,%ebx
  41:	75 e5                	jne    28 <main+0x28>
  }
  printf(1,"\n");
  43:	83 ec 08             	sub    $0x8,%esp
  46:	68 ac 07 00 00       	push   $0x7ac
  4b:	6a 01                	push   $0x1
  4d:	e8 de 03 00 00       	call   430 <printf>
  exit();
  52:	e8 6a 02 00 00       	call   2c1 <exit>
    printf(1, "Usage: %s words", argv[0]);
  57:	52                   	push   %edx
  58:	ff 30                	pushl  (%eax)
  5a:	68 98 07 00 00       	push   $0x798
  5f:	6a 01                	push   $0x1
  61:	e8 ca 03 00 00       	call   430 <printf>
    exit();
  66:	e8 56 02 00 00       	call   2c1 <exit>
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
malloc(uint nbytes)
{
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 747:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
